...
public class EmbeddedZooKeeper implements SmartLifecycle {
    ...
    /**
     * Provide an {@link ErrorHandler} to be invoked if an Exception is thrown from the ZooKeeper server thread. If none is
     * provided, only error-level logging will occur.
     * 
